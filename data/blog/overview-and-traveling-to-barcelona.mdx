...
![galicia-on-map](/static/images/overview-and-traveling-to-barcelona/galicia-on-map.jpeg)
...
![GitHub Logo](/static/images/overview-and-traveling-to-barcelona/catalonia-on-map.png)
...
| Republican forces                                 | Nationlist forces                                    |
| ------------------------------------------------- | ---------------------------------------------------- |
| Pre-existing governemnt                           | Revolted against pre-existing government             |
| Supported by USSR, France and Mexico              | Supported by Facist Italy, Nazi Germany and Portugal |
...
The war was ultimately won by the revolting Nationlist forces and Francisco Franco ruled Spain with virtually unilateral power for the next 36 years.

Remember when I said regional identities are very significant here? During the war, there were strong efforts by both sides to silence the cultural expression of occupied peoples. For example, in my home[^3] region of Galicia, the Nationalist occupiers outlawed the education of the Galician language, Gallego. What this means conventionally is that no one in my mom's generation is able to read or write in Galician. As a result, there's this almost, "lost generation" of Galicians that still are around today.
...
Don’t get me wrong, you can’t skip your final exam and expect your professor to be all "no pasa nada about it." But still, there’s something freeing about escaping the infinitely-climbing mentality we have across the Atlantic.

Overall, think of it like hakuna matata, but you're in Spain instead of Africa. Here's a picture of the gang for posterity:

![hakuna-mata.pjg](/static/images/overview-and-traveling-to-barcelona/hakuna-matata.jpeg)
...
Also fun fact, this website you're looking at is my brand-new portfolio! I've been spending a lot of time on it so if you have any feedback I would love to hear it. If you're curious [here](https://v2.jseanpa.tel) is the link to the last version, and [here](https://v1.jseanpa.tel) is my first version from back in high school.

## La Sagrada Familia

![sagrada-familia.png](/static/images/overview-and-traveling-to-barcelona/sagrada-familia.png)

## Things I have been eating

Don't tell anyone, but I've started eating meat again. Here are some good meals I've had:
...
I might be behind times, but I also just listened to the new Jack Harlow. It's definitely different than K-pop, I'll tell you that much. Overall, I really liked it too.
