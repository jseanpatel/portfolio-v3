...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Maple](/static/images/beach-time-in-pineda-de-mar-catalonia/pineda-streets.jpeg)
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Lake](/static/images/beach-time-in-pineda-de-mar-catalonia/pineda-streets.jpeg)
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Mountains](/static/images/beach-time-in-pineda-de-mar-catalonia/pineda-streets.jpeg)
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Toronto](/static/images/beach-time-in-pineda-de-mar-catalonia/pineda-streets.jpeg)
  </div>
</div>
...
<div className="flex flex-wrap -mx-2 overflow-hidden xl:-mx-2">
  ...
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Lake](/static/images/beach-time-in-pineda-de-mar-catalonia/barcelona-subway-long-view.jpeg)
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Mountains](/static/images/beach-time-in-pineda-de-mar-catalonia/barcelona-subway-platform.jpeg)
  </div>
  <div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2 xl:w-1/2">
    ![Toronto](/static/images/beach-time-in-pineda-de-mar-catalonia/barcelona-subway-track.jpeg)
  </div>
</div>
...
As many of you know I'm also studying education, so I love the idea of visiting the local university in each of the cities I visit. Unfortunately Pineda de Mar does not have a university as it was a smaller, beach town. So, University of Pineda de Mar isn't a real thing!
...
My expert opinion: a pretty deal.
...
I'm planning on discussing Spanish cuisine every week. In the meantime, enjoy this full course meal that I took pictures of.
...
[^2]: In Spain, there are no complimentary beverages - even water. During every meal you have to buy your own drinks even if you just want flat water. The good news is all beverages are pretty cheap by American standards, and usually you only spend about $1.50 USD on your drink, whether that be beer, soda or water.
